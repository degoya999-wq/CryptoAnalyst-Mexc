...
# (~600 монет). При 0.4с был частый троттлинг, при 0.6с — единичный. 0.8с
# ≈ 1.25 req/s должно убрать его полностью. Проход ≈ 8 мин — это нормально для
# 2H-сигнала (свеча живёт 2 часа). Если "Rate limit 2H" пропали и хочешь чаще
# сканировать — можно вернуть к 0.6.
SQUEEZE_SLEEP_2H         = 0.8
