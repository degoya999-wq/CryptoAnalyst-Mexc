...
async def _ws_main():
    ...
    logging.info("📡 WS main: starting 3 timeframe watchers + tickers watcher")
...
def health():
    ...
    return (f"✅ OK | Binance v7.3.7 (WS-tickers)\n"
            f"Uptime: {uptime}\n"
...
def startup_sequence():
    ...
    while True:
        try:
            logging.info("🚀 Startup v7.3.7: load_markets() (с retry + heartbeat)...")
            _safe_load_markets()
...
def start_bot():
    ...
    logging.info("🚀 start_bot v7.3.7: все фоновые потоки запущены")
